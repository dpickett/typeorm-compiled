...
var PostgresDriver = /** @class */ (function () {
    ...
    PostgresDriver.prototype.afterConnect = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var hasUuidColumns, hasCitextColumns, hasHstoreColumns, hasCubeColumns, hasGeometryColumns, hasExclusionConstraints;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(hasUuidColumns || hasCitextColumns || hasHstoreColumns || hasGeometryColumns || hasCubeColumns || hasExclusionConstraints)) return [3 /*break*/, 2];
                                        ...
                                        return tslib_1.__generator(this, function (_a) {
                                            switch (_a.label) {
                                                ...
                                                case 19:
                                                    ...
                                                    return [3 /*break*/, 20];
                                                case 20:
                                                    if (!hasExclusionConstraints) return [3 /*break*/, 24];
                                                    _a.label = 21;
                                                case 21:
...
var AuroraDataApiPostgresDriver = /** @class */ (function (_super) {
    ...
    function AuroraDataApiPostgresDriver(connection) {
        ...
        _this.client = new _this.DataApiDriver(_this.options.region, _this.options.secretArn, _this.options.resourceArn, _this.options.database, function (query, parameters) { return _this.connection.logger.logQuery(query, parameters); }, _this.options.serviceConfigOptions);
        return _this;
    }
    // -------------------------------------------------------------------------
    // Public Implemented Methods
